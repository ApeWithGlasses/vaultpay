    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="/web/registro" class="bg-[#1a4b8c] text-white px-6 py-2 rounded-lg hover:bg-[#2c6bc2] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
                        Registrarse
                    </a>
                </div>
            </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg absolute top-16 left-0 right-0 z-40">
            <div class="px-4 py-2 space-y-2">
                ...
                <a href="/web/registro" class="block text-center py-3 text-[#1a4b8c] font-semibold">Registrarse</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-3xl mx-auto px-4">
            <div class="bg-white rounded-2xl shadow-sm border border-[#1a4b8c]/10 p-8">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold text-[#1a4b8c] mb-2">Crea tu cuenta</h1>
                    <p class="text-neutral-gray-600">Únete a VaultPay y comienza a gestionar tus finanzas de manera segura</p>
                </div>
                ...
                <form action="/web/registro" method="POST" class="space-y-6">
                    <div>
                        <label for="name" class="block text-sm font-medium text-neutral-gray-700 mb-2">Nombre completo</label>
                    ...
                    <div>
                        <label for="telefono" class="block text-sm font-medium text-neutral-gray-700 mb-2">Teléfono</label>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terminos" class="ml-2 block text-sm text-neutral-gray-700">
                            Acepto los <a href="#" class="text-[#1a4b8c] hover:underline">términos y condiciones</a>
                        </label>
                    </div>
                    <button type="submit"
                ...
                <div class="text-center mt-6">
                    <p class="text-neutral-gray-600">
                        ...
                        <a href="/web/login" class="text-[#1a4b8c] hover:underline font-semibold">Inicia sesión</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <footer class="bg-[#1a4b8c] text-white py-12">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-lg font-semibold mb-4">VaultPay</h3>
                    <p class="text-white/80">Tu solución integral para la gestión de pagos y finanzas personales.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-center">
                            ...
                            <span class="text-white/80">info@vaultpay.com</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
